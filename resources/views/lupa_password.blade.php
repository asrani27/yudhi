            ...
            <div class="box box-warning"style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);border-top-color: #605ca8">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Masukkan Email</label>
                  <div class="col-sm-9">
              ...
              <div class="box-footer">
                <button type="submit" class="btn bg-purple btn-flat btn-block pull-right"><i class="fa fa-send"></i> Reset Password</button>
              </div>
              </form>
            </div>
          </div>
