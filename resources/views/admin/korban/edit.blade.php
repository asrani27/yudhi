...
<div class="row">
    <div class="col-md-12">
        <a href="/superadmin/korban" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a> <br /><br />
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-success">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/superadmin/korban/edit/{{$data->id}}">
                @csrf
